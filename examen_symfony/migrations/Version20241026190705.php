 ...
 */
final class Version20241026190705 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `show` (id INT AUTO_INCREMENT NOT NULL, numshow INT NOT NULL, nbrseat INT NOT NULL, dateshow DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
